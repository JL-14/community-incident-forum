# Generated by Django 5.0.1 on 2024-03-12 08:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_issue', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='forum.issue')),
            ],
            options={
                'ordering': ['created_on'],
            },
